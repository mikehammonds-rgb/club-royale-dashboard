...
const seedBookings = [
  { id: "wonder-2026-11-27", ship: "Wonder", port: "Miami", depart: "2026-11-27", return: "2026-11-30", nights: 3, offer: "2602C05", cabin: "Balcony", reservation: "9951558", crownAnchor: "385823429", companionReservation: "5160477", fare: 379, fareLabel: "Second guest fare", taxesFees: 271, total: 761.48, paymentStatus: "Paid in full", gratuities: "Prepaid and included", cruiseGratuitiesStatus: "Paid — prepaid and included", dining: "Specialty dining package — $297.24 total, paid in full with gratuities prepaid", diningPackage: "Specialty dining package", diningPackageTotal: 297.24, diningPackagePaymentStatus: "Paid in full", diningPackageStatus: "Purchased — paid in full", diningGratuitiesStatus: "Paid — prepaid and included in total", drinks: "Drink package — $509.64 total, paid in full with gratuities prepaid", drinkPackage: "Drink package", drinkPackageTotal: 509.64, drinkPackagePaymentStatus: "Paid in full", drinkPackageStatus: "Purchased — paid in full", drinkGratuitiesStatus: "Paid — prepaid and included in total", freePlay: 150, companions: ["Spring & Jon"], maybes: ["Ryan & David", "Britney & Eoghan"], notes: "Two 100-minute massages booked for 3:00 PM on Day 1; massage gratuities prepaid.", checklist: ["Confirm terminal and arrival time", "Review dining reservations", "Download boarding passes"], completed: [] },
